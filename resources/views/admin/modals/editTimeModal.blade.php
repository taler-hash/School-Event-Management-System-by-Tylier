                    ...
                    <div class="">
                        ...
                        <div class="grid grid-cols-2 gap-x-2">
                            <div class="">
                                ...
                                <input id="editStartTime" type="time" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                            </div>
                            <div class="">
                                <label class="block mb-2 text-xs font-medium text-gray-900 ">To</label>
                                <input type="time" id="editEndTime" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                            </div>
                        </div>
                    </div>
                </div>
