    ...
    <div class="relative w-full h-auto max-w-6xl md:h-auto">
        ...
        <div id="rawlogModalContent" class="relative bg-white rounded-lg shadow transition scale-0 duration-500 h-auto border border-gray-400 shadow-md shadow-gray-400">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t ">
                ...
                <button id="rawlogClose" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="defaultModal">
                ...
                <div class="">
                    <div class="flex">
                        ...
                        <div class="relative w-72 mb-2">
                            ...
                            <input type="search" id="default-search" class="searchInputRawlogs block w-full p-4 pl-10 pr-24 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." required>
                            <button type="submit" class="searchBarRawlogs text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
                        </div>
                    </div>
